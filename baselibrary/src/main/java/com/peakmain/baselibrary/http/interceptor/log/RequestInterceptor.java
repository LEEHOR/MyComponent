package com.peakmain.baselibrary.http.interceptor.log;

import android.support.annotation.Nullable;


import com.peakmain.baselibrary.utils.CharacterHandler;
import com.peakmain.baselibrary.utils.ZipHelper;
...
public class RequestInterceptor implements Interceptor {
    ...
    public static RequestInterceptor getInstance(Level level) {
        if (instance == null) {
            synchronized (RequestInterceptor.class) {
                if (instance == null) {
                    instance = new RequestInterceptor(level);
                }
            }
        }
        return instance;
